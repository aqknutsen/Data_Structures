...
*	@author : Alec Knutsen
*	@date : 2015.03.13
*	@brief: This class inherits from std::runtime_error. It uses the constructor of PreconditionViolationException to pass an error message to the constructor of std::runtime_error
*/
